...
int arrayMaior(int array[], int size){
	if(size == 1){ //se o array so tiver 1 elemento, retorne esse elemento;
		return array[0];
	}
	
	int maior = arrayMaior(array, size-1); //coloque a função recursiva dentro de uma variavel pra analise;
